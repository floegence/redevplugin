...
const performanceContract = readPerformanceContract(join(import.meta.dirname, "../testdata/quality/performance.json"));
...
function parseArgs(args) {
  const options = { output: "", measurements: "", comparisons: "", version: "", sourceCommit: "", generatedAt: "", gate: "" };
  ...
  for (const key of ["output", "measurements", "comparisons", "version", "sourceCommit", "gate"]) {
