...
export const pluginHostProtocolVersion = "plugin-host-v3" as const;
...
export const redevPluginContractVersions = {
  ...
  "compatibility_manifest_version": "redevplugin.compatibility.v5",
...
export const redevPluginContractArtifacts = [
  {
    ...
    sha256: "21ff05b6008cb98732f8bf69766189db13632edaf271880dad6e99cbe5ef8be9",
  },
  {
    id: "manifest-schema",
