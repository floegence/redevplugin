...
export const pluginUIProtocolVersion = "plugin-ui-v6" as const;
export const pluginHostProtocolVersion = "plugin-host-v8" as const;
export const bridgeSchemaVersion = "bridge-v6" as const;
