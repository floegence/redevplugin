...
export interface paths {
    ...
    "/_redevplugin/api/plugins/release-packages/inspect": {
        ...
        get?: never;
        put?: never;
        /** @description Resolves and fully verifies an exact release reference before installation so one user confirmation can review the Host-derived permissions and package identity. The inspection does not perform runtime or lifecycle preflight and returns short-lived session-bound evidence that installation consumes without downloading or parsing the package again. */
