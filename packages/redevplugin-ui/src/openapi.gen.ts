...
export interface components {
    schemas: {
        ...
        Event: {
            ...
            payload?: {
                install_progress?: components["schemas"]["ReleaseInstallProgressEvent"];
            } & {
                [key: string]: unknown;
            };
            error?: components["schemas"]["PublicError"];
        };
        ReleaseInstallProgressEvent: {
            task_id: string;
            request_id: string;
            /** @enum {string} */
            stage: "download" | "verify" | "install" | "enable";
            /** @enum {string} */
