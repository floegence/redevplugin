...
```toml
[dependencies]
redevplugin-worker-sdk = { git = "https://github.com/floegence/redevplugin", tag = "v0.4.3" }
serde_json = "1.0"
```
...
`sdk/redevplugin-worker-sdk-0.4.3.crate` source artifact and records its SHA-256
