...
func CurrentPublicAPICatalog() PublicAPICatalog {
	return PublicAPICatalog{
		...
		StableErrorCodes: []string{"ALREADY_EXISTS", "CANCELED", "CROSS_DEVICE", "INTERNAL", "INVALID_ARGUMENT", "IO_ERROR", "NETWORK_ERROR", "NOT_EMPTY", "NOT_FOUND", "PERMISSION_DENIED", "REDIRECT_REQUIRES_REPLAY", "RESOURCE_CLOSED", "RESOURCE_LIMIT", "RUNTIME_UNAVAILABLE", "SECURITY_INCOMPATIBLE", "TIMEOUT", "UNSUPPORTED_FEATURE", "WOULD_BLOCK"},
