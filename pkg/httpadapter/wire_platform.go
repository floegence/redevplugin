...
type compatibilityMatrixResponse struct {
	...
	PluginUITransportMappings           []version.PluginUITransportMapping `json:"plugin_ui_transport_mappings"`
...
func publicCompatibility(source version.CompatibilityManifest) compatibilityResponse {
	...
	return compatibilityResponse{
		...
		Matrix: compatibilityMatrixResponse{
			PluginUIProtocolVersion:           matrix.PluginUIProtocolVersion,
			SupportedPluginUIProtocolVersions: append([]string(nil), matrix.SupportedPluginUIProtocolVersions...),
			PluginUITransportMappings:         append([]version.PluginUITransportMapping(nil), matrix.PluginUITransportMappings...),
			PluginHostProtocolVersion:         matrix.PluginHostProtocolVersion,
