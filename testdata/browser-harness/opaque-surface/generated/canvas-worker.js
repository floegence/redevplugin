...
(() => {
  ...
  function validatePluginUITree(tree2) {
    if (!isElement(tree2)) {
  ...
  var PluginBridgeClient = class {
    ...
    render(tree2) {
      ...
      let validated;
      try {
        validated = validatePluginUITree(tree2);
      } catch (error) {
  ...
  // testdata/browser-harness/opaque-surface/canvas-worker.ts
  var bridge = new PluginBridgeClient({ timeoutMs: 1e3 });
    ...
    return {
      ...
      children: [
        ...["first", "second"].map((id) => ({
          ...
          key: id,
          tag: "canvas",
          attributes: { id, width: 300, height: 150, "data-redevplugin-canvas": id },
          children: []
        })),
