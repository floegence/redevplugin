...
Sandbox asset responses include restrictive CSP, reporting, permissions,
referrer, CORP, nosniff, and service-worker scope headers. The Host supplies
exact frame ancestors when embedding plugin surfaces.
