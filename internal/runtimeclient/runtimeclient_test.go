...
func TestValidateHelloAckRejectsNonCanonicalPayload(t *testing.T) {
	...
	for _, payload := range []string{
		`{"internal_wire":1,"platform_version":"3.0.5","runtime_artifact_sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","connection_nonce":"nonce_1234567890123456","future":true}`,
		`{"internal_wire":1,"platform_version":"3.0.5","platform_version":"3.0.6","runtime_artifact_sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","connection_nonce":"nonce_1234567890123456"}`,
		`{"internal_wire":1,"platform_version":"3.0.5","PLATFORM_VERSION":"3.0.6","runtime_artifact_sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","connection_nonce":"nonce_1234567890123456"}`,
		`{"internal_wire":1,"PLATFORM_VERSION":"3.0.5","runtime_artifact_sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","connection_nonce":"nonce_1234567890123456"}`,
		`{"internal_wire":1,"platform_version":"3.0.5","runtime_artifact_sha256":"aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa","connection_nonce":"nonce_1234567890123456"} {}`,
	} {
		frame := baseFrame
